...
struct ContentView: View {
    ...
    /// Waypoints of this convent view.
    ...
    /// Cuurent waypoint at the current step.
    ...
    /// Creates a new content view instance with an inital set of waypoints.
    ///
    /// - Parameter waypoints: to initialize this content view with.
    ///
    /// - Returns: A new content view instance with initial waypoints set to `waypoint`.
    ...
    /// Displays a map that dynamically draws a circle at the current waypoint and a label containing the heartrate at the time
    var body: some View {
        VStack {
